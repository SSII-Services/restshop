...
/**
 * A functional component that renders the contact page.
 * It includes a form to send messages, contact information, and links to social media.
 *
 * @return {JSX.Element} The JSX element representing the contact page.
 */
            ...
            <div className="container">
                ...
                <div className="m-0 form">
                    <div className="contact-info">
                        ...
                        <div className="info">
                            <div className="gap-3 information">
                                <span className="p-2 text-blue-500 bg-blue-100 rounded-md"> 
                            ...
                            <h4 className="text-xl font-semibold" style={{ color: '#349ebf'}}> Connect with us : </h4>
